...
void
display_statistics(user_profile *puser)
{
...
void
display_seq(user_profile *puser)
{
...
void
set_up_index(user_profile *puser)
{
...
void
init_user(user_profile *puser, const string &nm, int level)
{
...
bool
correct_guess(user_profile *puser, int guess)
{
  pvec p = seq_vec(puser);
